...
gulp.task('scripts',function(){
    return gulp.src(['node_modules/jquery/dist/jquery.min.js','node_modules/jquery.maskedinput/src/jquery.maskedinput.js','node_modules/slick-carousel/slick/slick.js'])
      .pipe(gp.plumber())
...
gulp.task('default',gulp.series(
    gulp.parallel('sass', 'html','scripts','scripts:main','img:dev'),
